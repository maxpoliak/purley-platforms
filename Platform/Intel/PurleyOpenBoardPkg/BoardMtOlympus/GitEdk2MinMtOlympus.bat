...
set PACKAGES_PATH=%WORKSPACE%\purley-platforms\Platform\Intel;%WORKSPACE%\purley-platforms\Silicon\Intel;%WORKSPACE%\edk2-non-osi\Silicon\Intel;%WORKSPACE%\edk2;%WORKSPACE%
